      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="card-body">
            ...
            <form:form action="add/insert" modelAttribute="user" class="forms-sample" method="post">
              <div class="form-group">
                <form:hidden  class="form-control" id="exampleInputName1" placeholder="Name" path="user_id" />
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <form:hidden  class="form-control" id="exampleInputName6" placeholder="Name" path="active" />
              </div>
